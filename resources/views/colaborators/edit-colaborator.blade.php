<x-layout-app page-title="Edit Colaborator">
    ...
    <div class="w-100 p-4">
        ...
        <form action="{{ route('colaborators.rh-management.update-colaborator') }}" method="post">
            ...
            <div class="container-fluid">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="select_department" name="select_department">
                                    @foreach ($departments as $department)
                                        <option
                                            value="{{ $department->id }} {{ $colaborator->id == $department->id ? 'selected' : '' }}">
                ...
                <div class="mt-3">
                    <a href="{{ route('colaborators.rh-management.home') }}"
