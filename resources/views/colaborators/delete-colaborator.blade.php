<x-layout-app page-title="Delete colaborator confirmation">
    <div class="w-25 p-4">
        ...
        <div class="text-center">
            ...
            <a href="{{ route('colaborators.rh-management.home') }}" class="btn btn-secondary px-5">No</a>
            <a href="{{ route('colaborators.rh-management.delete-colaborator-confirm', ['id' => $colaborator->id]) }}"
